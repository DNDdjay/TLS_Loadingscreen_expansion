...
class CfgPatches
{
    class TLS_LoadingScreen_ExpansionMainMenuScenes
    {
        units[]={};
        weapons[]={};
        requiredVersion=0.1;
...
class cfgExpansionCharacterScenes
{
    class ChernarusPlus // The name of the map
    {
        class MySceneName // The name of your scene
        {
            ...
            MappingFiles[]=
            {
                "TLS_LoadingScreen_expansion/TLS_LoadingScreen/MainMenuScenes/MyMapFile" // The path to your .map file, it allows you to load a custom mapping to your scene
            };
