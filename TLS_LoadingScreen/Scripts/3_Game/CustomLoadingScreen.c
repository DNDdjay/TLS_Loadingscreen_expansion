...
const string LOADING_SCREENS_PATH 	= "TLS_LoadingScreen/Data/LoadingImages.json";
const string LOADING_MESSAGES_PATH 	= "TLS_LoadingScreen/Data/LoadingMessages.json";
const string LOADING_SCREEN_LOGO 	= "TLS_LoadingScreen/Pictures/loading_screen_2_co.edds";
									//! ModName/Path/File
